# 1 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\dataconsistency\\\\combined_DataConsistency.c"
...
# 1 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\dataconsistency\\\\combined_DataConsistency.c" 2
...
# 2 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\dataconsistency\\\\combined_DataConsistency.c" 2
...
# 3 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\dataconsistency\\\\combined_DataConsistency.c" 2
...
# 4 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\dataconsistency\\\\combined_DataConsistency.c" 2
...
Action()
{
	...
	lr_end_transaction("Consistency-Create", 2);
	...
	lr_end_transaction("Consistency-Login", 2);
	...
	lr_end_transaction("Consistency-Get-credential", 2);
	...
	lr_end_transaction("Consistency-Delete-account", 2);
	
	web_remove_auto_header("Authorization", "ImplicitGen=Yes");
	
	return 0;
}
# 5 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\dataconsistency\\\\combined_DataConsistency.c" 2
...
# 6 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\dataconsistency\\\\combined_DataConsistency.c" 2
