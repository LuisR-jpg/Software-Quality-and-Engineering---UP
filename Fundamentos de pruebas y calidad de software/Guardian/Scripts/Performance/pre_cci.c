# 1 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\performance\\\\combined_Performance.c"
...
# 1 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\performance\\\\combined_Performance.c" 2
...
# 2 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\performance\\\\combined_Performance.c" 2
...
# 3 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\performance\\\\combined_Performance.c" 2
...
vuser_init()
{
	...
	lr_end_transaction("Performance-Create", 2);
	...
	lr_end_transaction("Performance-Login", 2);
	
	web_add_auto_header("Authorization", "Bearer {token}");
	
	return 0;
}
# 4 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\performance\\\\combined_Performance.c" 2
...
Action()
{
	...
	lr_end_transaction("Performance-Create-Credential", 2);
	...
	lr_end_transaction("Performance-List", 2);
	...
	lr_end_transaction("Performance-Delete-credential", 2);
	
	return 0;
}
# 5 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\performance\\\\combined_Performance.c" 2
...
vuser_end()
{
	...
	lr_end_transaction("Performance-Delete-account", 2);
	
	web_remove_auto_header("Authorization", "ImplicitGen=Yes");
	return 0;
}
# 6 "c:\\users\\lalor\\documents\\git\\software-quality-and-engineering---up\\fundamentos de pruebas y calidad de software\\guardian\\performance\\\\combined_Performance.c" 2
